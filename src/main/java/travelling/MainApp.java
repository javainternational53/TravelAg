...
public class MainApp extends Application {
	...
	public MainApp() {
		...
		travelData.add(new Travel("Eger", 2500.0, 25000.0, "yes",2));
		travelData.add(new Travel("Salgotarjan", 2500.0, 25000.0, "yes",2));
		travelData.add(new Travel("Kecskemet", 2500.0, 25000.0, "yes",2));
		travelData.add(new Travel("Szekszard", 2500.0, 25000.0, "yes",2));
		travelData.add(new Travel("Pecs", 2500.0, 25000.0, "yes",2));
		travelData.add(new Travel("Szekesfehervar", 2500.0, 25000.0, "yes",2));
		travelData.add(new Travel("Tatabanya", 2500.0, 25000.0, "yes",2));
		travelData.add(new Travel("Kaposvar", 2500.0, 25000.0, "yes",2));
